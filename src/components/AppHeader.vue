<template>
  <header class="bg-base-300">
    <nav class="navbar navbar-end max-w-5xl w-full mx-auto">
      <ul class="menu menu-horizontal p-0">
        <li>
          <router-link :to="{ name: ROUTE_LIST_TRANSCRIPT }" class="link-accent"
            >My transcripts</router-link
          >
        </li>
        <li tabindex="0">
          <p>My account</p>
