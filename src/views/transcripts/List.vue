...
const deleteModal = createConfirmDialog(ConfirmModal,{confirmText: "Do you really want to delete this transcript ?"})
...
const deleteTranscript = async (id: string) => {
  ...
  if(!result) return
  try {
    await databases.deleteDocument(import.meta.env.VITE_PODCAST_DB_ID, import.meta.env.VITE_PODCAST_COL_ID, id)
